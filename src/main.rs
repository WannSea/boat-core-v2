...
mod transport;
mod component;
use component::{computed::{power::MotorPower, sensor_fusion::SensorFusion}, gps::GPS, imu::IMU, lte::LTE, pmu::PMU, system_stats::SystemStats, vesc::{self, VESC}};
use config::Config;
...
async fn main() {
    ...
    let motor_power: MotorPower = MotorPower::new(metric_sender.clone());
    motor_power.start();
